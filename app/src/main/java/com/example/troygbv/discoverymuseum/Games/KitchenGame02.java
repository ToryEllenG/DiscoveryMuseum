...
public class KitchenGame02 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayout gridLayout = (GridLayout) findViewById(R.id.grid_layout_2x2);
